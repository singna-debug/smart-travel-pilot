...
6. ★가는편/오는편 항공 스케줄 필수★: <항공 일정 내역> 및 <여행 상세 정보>를 참고하여, departureFlightNumber, returnFlightNumber (편명) 및 departureTime, arrivalTime, returnDepartureTime, returnArrivalTime (HH:mm) 을 모두 한 치의 누락 없이 반드시 채워 넣으세요.
7. JSON 외 텍스트 출력 절대 금지.
